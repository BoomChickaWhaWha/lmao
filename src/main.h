...
static const int64_t COIN_YEAR_REWARD = 200 * CENT; // 2% per year
static const int64_t MAX_MINT_PROOF_OF_STAKE = 20 * COIN;	//2% annual interest
static const int MODIFIER_INTERVAL_SWITCH = 696;
