...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "BoomChickawahwah - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "BoomChickawahwah Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the BoomChickawahwah debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the BoomChickawahwah-Qt help message to get a list with possible BoomChickawahwah command-line options.", 0));
#endif // QT_NO_TOOLTIP
