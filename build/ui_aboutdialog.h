...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About BoomChickawahwah", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>BoomChickawahwah</b> version", 0));
...
"Copyright \302\251 2014 The BoomChickawahwah developers", 0));
